...
class ModeleVoiture
{
    ...
    public static function getVoitures(): array
    {
        ...
        foreach ($pdoStatement as $voitureFormatTableau)
            $voitures[] = new ModeleVoiture($voitureFormatTableau['immatriculation'], $voitureFormatTableau['marque'], $voitureFormatTableau['couleur'], $voitureFormatTableau['nbSieges']);
    ...
    public static function getVoitureParImmatriculation(string $immatriculation): ?ModeleVoiture
    {
        ...
        return $voitureFormatTableau ? ModeleVoiture::construireDepuisTableau($voitureFormatTableau) : null;
    }
